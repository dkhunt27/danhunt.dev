<template>
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
    <div v-on:click.prevent="$scrollTo('#about')" class="navbar-brand">
      <span class="d-block d-lg-none">Dan Hunt</span>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" v-on:click.prevent="$scrollTo('#certifications')">Certifications</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" v-on:click.prevent="$scrollTo('#feedback')">Peer Feedback</a>
        </li>
      </ul>
    </div>
  </nav>
